...
class AssetServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        Asset::add('bootstrap_js', 'js/bootstrap.min.js', [], $theme->getHeader('version'))->to('front');
        Asset::add('theme_js', 'js/theme.min.js', ['bootstrap.min.js'], $theme->getHeader('version'))->to('front');
    }
}
